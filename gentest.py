...
p.add_argument("--numqueries", default=None, type=int, help="The number of queries to make")
p.add_argument("--interleave", default=False, type=bool, help="Set this to mix inserteions with queries; otherwise all queries will follow all insertions")

args = p.parse_args()

print args
numentries = args.numentries or randrange(1, 100000)
numqueries = args.numqueries or randrange(1, 100000)
